...
-- Limpiar también las policies nuevas por si se ejecutó antes parcialmente
DROP POLICY IF EXISTS "Authenticated users can view profiles" ON public.users;
DROP POLICY IF EXISTS "Users can update own row" ON public.users;
DROP POLICY IF EXISTS "Authenticated users can insert profile" ON public.users;
...
DROP POLICY IF EXISTS "Anon can view documents" ON public.documents;
...
DROP POLICY IF EXISTS "Authenticated can view signers" ON public.signers;
DROP POLICY IF EXISTS "Authenticated can create signers" ON public.signers;
DROP POLICY IF EXISTS "Authenticated can update signers" ON public.signers;
DROP POLICY IF EXISTS "Anon can view signers" ON public.signers;
DROP POLICY IF EXISTS "Anon can update signers" ON public.signers;
...
DROP POLICY IF EXISTS "Authenticated can modify pricing" ON public.pricing_configs;
...
DROP POLICY IF EXISTS "Authenticated can manage lemon config" ON public.lemon_config;
