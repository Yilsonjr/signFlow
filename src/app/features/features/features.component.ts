  ...
  template: `
    <div class="page">
      <section class="hero-section">
        <div class="container">
          <div class="eyebrow">
            ...
            <span class="eyebrow-text">Caracteristicas</span>
          </div>
          <h1 class="page-title">
            <span class="title-dark">Todo lo que necesitas</span><br>
            <span class="title-blue">para firmar con confianza.</span>
          </h1>
        ...
        <div class="container">
          <div class="grid">
            ...
            <div class="feature-card">
              ...
              <h3>Envio rapido</h3>
              <p>Sube un PDF, define zonas de firma y envia en segundos. Cada firmante recibe un link unico y seguro.</p>
            </div>
            ...
            <div class="feature-card">
              ...
              <p>Firma con un trazo natural sobre la pantalla. Dibuja tu firma una vez y reutiliza en todos los documentos.</p>
            </div>
            ...
            <div class="feature-card">
              ...
              <h3>Validez legal</h3>
              <p>Cumple con eIDAS, ISO 27001 y SOC 2 Type II. Audit trail completo con sello temporal y evidencia inviolable.</p>
            </div>
            ...
            <div class="feature-card">
              ...
              <h3>Multiples firmantes</h3>
              <p>Envia un documento a varios firmantes con orden de firma configurable. Recibe notificaciones en tiempo real.</p>
            </div>

            <div class="feature-card">
              <div class="feature-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
              </div>
              <h3>Dashboard completo</h3>
              <p>Visualiza el estado de cada documento, gestiona firmantes y controla tu plan desde un panel centralizado.</p>
            </div>
            ...
            <div class="feature-card">
              ...
              <h3>Sin fricciones</h3>
              <p>Los firmantes no necesitan crear cuenta. Reciben un codigo de 8 caracteres y firman en menos de un minuto.</p>
            </div>
      ...
      <section class="cta-section">
        <div class="container">
          <h2>Comienza a firmar hoy</h2>
          <p>3 documentos gratis al mes, sin tarjeta de credito.</p>
