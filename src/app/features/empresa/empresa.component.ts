...
@Component({
  ...
  template: `
    <div class="page">
      <section class="hero-section">
        <div class="container">
          <div class="eyebrow">
            ...
            <span class="eyebrow-text">Empresa</span>
          </div>
          <h1 class="page-title">
            <span class="title-dark">Construimos firma digital</span><br>
            <span class="title-blue">con la confianza que mereces.</span>
          </h1>
          <p class="page-subtitle">SignFlow nacio para eliminar la friccion de los procesos de firma. Hoy ayudamos a miles de profesionales y empresas a cerrar acuerdos mas rapido, con plena validez legal.</p>
        </div>
      </section>
        ...
        <div class="container">
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <div class="stat-label">Tiempo promedio de firma</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="values-grid">
            <div class="value-card">
              ...
              <p>Cifrado extremo a extremo, cumplimiento eIDAS, ISO 27001 y SOC 2. Tu informacion esta protegida en cada paso.</p>
            </div>
            <div class="value-card">
              <div class="value-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              </div>
              <h3>Velocidad sin compromiso</h3>
              <p>Firma un documento en menos de 2 minutos. Sin registros, sin descargas, sin esperas. La rapidez sin sacrificar seguridad.</p>
            </div>
            <div class="value-card">
              <div class="value-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
              </div>
              <h3>Para todos</h3>
              <p>Desde freelancers hasta equipos corporativos. Planes flexibles que crecen contigo, sin contratos de permanencia.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="compliance-grid">
            <div class="compliance-card">
              <div class="compliance-badge">eIDAS</div>
              <p>Reglamento europeo de identificacion electronica y servicios de confianza. Validez legal plena.</p>
            </div>
            <div class="compliance-card">
              <div class="compliance-badge">ISO 27001</div>
              <p>Gestion de seguridad de la informacion. Procesos auditados y certificados internacionalmente.</p>
            </div>
            <div class="compliance-card">
              <div class="compliance-badge">SOC 2 Type II</div>
              <p>Controles de seguridad, disponibilidad y confidencialidad verificados por auditores independientes.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="cta-section">
        <div class="container">
          <h2>Unete a miles de profesionales</h2>
          <p>Comienza a firmar digitalmente hoy. Sin tarjeta de credito.</p>
          <a class="cta-btn" routerLink="/register">Crear cuenta gratis</a>
        </div>
      </section>
    </div>
  `,
  styles: [`
    ...
    @media (max-width: 768px) {
      ...
      .stats-grid, .values-grid, .compliance-grid { grid-template-columns: 1fr; }
    }
  `]
})
